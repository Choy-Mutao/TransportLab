// The source from [Particle Swarm Optimization Using C#](https://visualstudiomagazine.com/Articles/2013/11/01/Particle-Swarm-Optimization.aspx?Page=1)

namespace ParticleSwarmOptimization
{
    // The Demo is to solve the Double-Dip function z = x*Math.Exp(-(x^2 + y^2))
